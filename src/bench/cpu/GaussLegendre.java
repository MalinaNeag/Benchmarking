...
class GaussLegendre {
    ...
    /*public static void main(String[] args) {
        ...
        BigDecimal y = approxPi();
        System.out.println("Hence pi value is " + y);
    }
*/
    public static BigDecimal approxPi() {
        ...
        BigDecimal pie = (ar[precision - 1].add(br[precision - 1])).pow(2).divide(tr[precision - 1].multiply(BigDecimal.valueOf(4)), precision,
